    ...
    <head>
        ...
        <style>
            ...
            ::-webkit-scrollbar-track {
              box-shadow: inset 7px 10px 20px #03386e; 
            ...
            ::-webkit-scrollbar-thumb {
              background: rgba(162, 199, 249,1); 
              border-radius: 10px;
            }

            /* Handle on hover */
            ::-webkit-scrollbar-thumb:hover {
              background: rgba(3, 56, 110,1);
            }
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <div class="navbar-header h">
                        ...
                        <a class="navbar-brand colorlink" href="#">Parking</a>
                    </div>
                </div>
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav ">
                  ...
                  <li class="active"><a class="colorlink" href="#">Home <span class="sr-only">(current)</span></a></li>
                  
                  <li><a class="colorlink" href="#about">About us</a></li>
                  <li><a class="colorlink" href="#services">Services</a></li>
                  <li><a class="colorlink" href="#projects">Previous projects</a></li>
                    
                  <li><a class="colorlink" href="" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Contact us</a></li>
      ...
      <input type="text" class="form-control" placeholder="Phone Number" aria-label="...">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                  <a href="" class="btn btn-primary" target="_blank">Send</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="copyright">
            <p style="font-size: 20px;">© 2023 by Parking. All rights reserved.</p>
